...
// +kubebuilder:rbac:groups=efs.services.k8s.aws,resources=mounttargets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=efs.services.k8s.aws,resources=mounttargets/status,verbs=get;update;patch
