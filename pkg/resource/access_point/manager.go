...
// +kubebuilder:rbac:groups=efs.services.k8s.aws,resources=accesspoints,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=efs.services.k8s.aws,resources=accesspoints/status,verbs=get;update;patch
